...
public class MagicCircleN extends View {
    ...
    public MagicCircleN(Context context) {
        super(context);
    }

    public MagicCircleN(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MagicCircleN(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    @Override protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        centerY = height / 2;
        radius = 50;  //r
        c = radius*blackMagic;  //r*c
        stretchDistance = radius;  //r
        moveDistance = radius*(3/5f);  // move = 0.6r
        cDistance = c*0.45f;  //r*c*0.45
        maxLength = width - radius -radius;   //width -2r
    }
