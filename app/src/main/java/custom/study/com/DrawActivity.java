...
public class DrawActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CHANNELS[0] = "AfterOnDrawView";
        CHANNELS[1]="BeforeOnDrawView";
        CHANNELS[2]="OnDrawLayout";
        CHANNELS[3]="DispatchDrawLayout";
        CHANNELS[4]="AfterOnDrawForegroundView";
        CHANNELS[5]="BeforeOnDrawForegroundView";
    ...
    public void initViewPager() {
        ...
        fragmentContainter.add(PageFragment.newInstance(R.layout.draw_on_after_view));
        fragmentContainter.add(PageFragment.newInstance(R.layout.draw_on_before_view));
        fragmentContainter.add(PageFragment.newInstance(R.layout.draw_on_layout_view));
        fragmentContainter.add(PageFragment.newInstance(R.layout.draw_on_layout_dispatch_view));
        fragmentContainter.add(PageFragment.newInstance(R.layout.draw_on_draw_foreground_view));
        fragmentContainter.add(PageFragment.newInstance(R.layout.draw_on_draw_foreground_before_view));
